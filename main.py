...
class VoxelEngine:
    def __init__(self):
        ...
        self.vertex_array = generate_world_mesh()
        self.mesh_changed = True
                
        # Load an image using PIL
        image = Image.open('textures/cobblestone.png').transpose(Image.FLIP_TOP_BOTTOM)
    ...
    def update(self):
        ...
        self.camera.rotate_yaw(mouse_dx * PLAYER_ROTATION_SPEED)
        self.camera.rotate_pitch(mouse_dy * PLAYER_ROTATION_SPEED)
